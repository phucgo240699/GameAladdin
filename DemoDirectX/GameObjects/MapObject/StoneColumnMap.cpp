#include "StoneColumnMap.h"



StoneColumnMap::StoneColumnMap()
{
	LoadMap("./Resources/ListImage/StoneColumnMap.png");
}
...
void StoneColumnMap::LoadMap(char * filePath)
{
	int r, c;
...
void StoneColumnMap::Update()
{
}

void StoneColumnMap::Draw()
{
...
void StoneColumnMap::SetCamera(Camera * camera)
{
	this->camera = camera;
}
